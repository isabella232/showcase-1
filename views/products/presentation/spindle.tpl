...
<p>
  Using homomorphic encryption in machine learning allows SPINDLE to both ensure
  the privacy of data and to make
...
<div align="center">
  <img class="dark" src="/resources/products/images/spindle/network.svg" />
</div>
