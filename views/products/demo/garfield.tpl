...
<p>
    ...
    the Decentralized Learning model, showing how
    training on more data improves learning, while still keeping control on
    one’s data. Finally, it shows the negative impact that faulty
