<img src="../../../resources/incubator/images/freegaen/microg_full_colored.svg" width="30%"
...
<p>Apple and Google developed the Google-Apple Exposure Notification
    ...
    applications.</p>
<p> This project aims to offer an alternative framework, based on
    open-source code, which requires only minimal changes to the apps.</p>
<p>
    ...
    collaborating with <a href="https://microg.org/">microG</a>, a Free Software project dedicated to
