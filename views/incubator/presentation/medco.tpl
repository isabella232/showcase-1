<img src="../../../resources/incubator/images/medco/logo.png" class="left dark dark_pad"/>
...
securely share them with investigators, without single points of failure.
</p>
<p>MedCo applies advanced privacy and security techniques, such as:</p>
<ul>
    <li>Collective homomorphic encryption</li>
